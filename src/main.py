...
A macOS system monitoring and startup management tool.
"""
...
class MainWindow(QMainWindow):
    ...
    def load_fonts(self):
        ...
        try:
            ...
            logger.warning("Could not load custom fonts: %s. Falling back to system fonts.", e)
    ...
    def _save_guide_preference(self):
        ...
        try:
            ...
            logger.warning("Could not save guide preference: %s", e)
...
def main():
    ...
    try:
        ...
        logger.warning("Could not set application font: %s", e)
