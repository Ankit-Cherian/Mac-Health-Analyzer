...
from utils.startup_descriptions import StartupItemDescriber


class TestStartupItemDescriber:
    """Test StartupItemDescriber class."""

    def test_initialization(self):
        """Test StartupItemDescriber initialization."""
        describer = StartupItemDescriber()
