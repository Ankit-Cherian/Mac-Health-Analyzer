# Contributing to Mac Health Analyzer

Hello! Thanks for checking out Mac Health Analyzer. I appreciate any contributions, whether it's a bug fix, new feature, or just fixing a typo in the docs.

## Getting Started

1. Fork the repo
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Mac-Health-Analyzer.git`
3. Create a new branch: `git checkout -b your-feature-name`
4. Make your changes
5. Run the tests to make sure nothing broke: `./scripts/run_tests.sh`
